...
function main() {
  ...
  function loadShark() {
    {
      ...
      gltfLoader.load(
        "models/great_white_shark/scene.gltf",
        function (object) {
  ...
  function loadIsland() {
    {
      const gltfLoader = new GLTFLoader();
      gltfLoader.load(
        "models/lonelypenguin/scene.gltf",
        function (object) {
          var model = object.scene;
  ...
  var cubeMaterial = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("textures/morning/morning_ft.png"),
      side: THREE.BackSide,
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("textures/morning/morning_bk.png"),
      side: THREE.BackSide,
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("textures/morning/morning_up.png"),
      side: THREE.BackSide,
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("textures/morning/morning_dn.png"),
      side: THREE.BackSide,
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("textures/morning/morning_rt.png"),
      side: THREE.BackSide,
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("textures/morning/morning_lt.png"),
      side: THREE.BackSide,
    }),
  ];
  ...
  window.setTimeout(function () {
    ...
    var nightCubeMaterial = [
      new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("textures/night/nightsky_ft.png"),
        side: THREE.BackSide,
      }),
      new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("textures/night/nightsky_bk.png"),
        side: THREE.BackSide,
      }),
      new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("textures/night/nightsky_up.png"),
        side: THREE.BackSide,
      }),
      new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("textures/night/nightsky_dn.png"),
        side: THREE.BackSide,
      }),
      new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("textures/night/nightsky_rt.png"),
        side: THREE.BackSide,
      }),
      new THREE.MeshBasicMaterial({
        map: new THREE.TextureLoader().load("textures/night/nightsky_lf.png"),
        side: THREE.BackSide,
      }),
    ];
  ...
  var planeMaterial = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load("./textures/bolt.png"),
