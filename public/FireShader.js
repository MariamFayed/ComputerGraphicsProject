...
THREE.Fire = function (fireTex, color) {
  ...
  fireMaterial.uniforms.color.value = color || new THREE.Color(0xfff);
  fireMaterial.uniforms.invModelMatrix.value = new THREE.Matrix4();
  fireMaterial.uniforms.scale.value = new THREE.Vector3(20, 20, 20);
  fireMaterial.uniforms.seed.value = Math.random() * 19.19;
  //   fireMaterial.lights = true;

  console.log(fireMaterial);

  THREE.Mesh.call(this, new THREE.BoxGeometry(20, 20, 20), fireMaterial);
};
...
var firefunc = THREE.Fire;

export { firefunc };
export default firefunc;
